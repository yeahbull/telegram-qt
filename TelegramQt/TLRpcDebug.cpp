...
#include "../server/FunctionStreamOperators.hpp"
...
void dumpRpc(CTelegramStream &stream)
{
    ...
    case TLValue::PingDelayDisconnect: {
        quint64 lastSentPingId;
        stream >> lastSentPingId;
        quint32 disconnectInSec;
        stream >> disconnectInSec;
        qDebug() << request << "lastSentPingId" << lastSentPingId << "disconnectInSec" << disconnectInSec;
        break;
    }
